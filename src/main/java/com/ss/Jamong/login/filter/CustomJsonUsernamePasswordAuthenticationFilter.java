package com.ss.Jamong.login.filter;
...
public class CustomJsonUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String USERNAME_KEY = "username"; // 회원 로그인 시 username 요청 JSON Key : "username"
     ...
     * Map의 Key(username, password)로 해당 username, 패스워드 추출 후
