package com.ss.Jamong.oauth2.service;
...
@Service
public class CustomizedOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    @Autowired
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (registrationId=="naver"){
            ...
            throw new OAuth2AuthenticationException("네이버나 구글이 아닌 인증 사용");
        }
        User user;
